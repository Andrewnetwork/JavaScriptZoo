...
This project was produced by following the [TypeScript-React-Starter](https://github.com/Microsoft/TypeScript-React-Starter) tutorial (with some modification).
...
- [Running Tests](#running-tests)
  ...
  - [Initializing Test Environment](#initializing-test-environment)
    - [`src/setupTests.ts`](#srcsetupteststs-1)
